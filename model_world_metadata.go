...
// checks if the WorldMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorldMetadata{}
...
func (o WorldMetadata) ToMap() (map[string]interface{}, error) {
