...
// checks if the InviteMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InviteMessage{}
...
func NewInviteMessageWithDefaults() *InviteMessage {
	...
	this.CanBeUpdated = canBeUpdated
	var messageType InviteMessageType = MESSAGE
	this.MessageType = messageType
...
func (o InviteMessage) ToMap() (map[string]interface{}, error) {
