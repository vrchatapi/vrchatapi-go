...
// checks if the Verify2FAEmailCodeResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Verify2FAEmailCodeResult{}
...
func (o Verify2FAEmailCodeResult) ToMap() (map[string]interface{}, error) {
