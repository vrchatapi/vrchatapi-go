...
// checks if the CreateGroupRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupRoleRequest{}
...
func (o CreateGroupRoleRequest) ToMap() (map[string]interface{}, error) {
