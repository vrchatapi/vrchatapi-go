...
// checks if the UserExists type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserExists{}
...
func (o UserExists) ToMap() (map[string]interface{}, error) {
