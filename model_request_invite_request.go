...
// checks if the RequestInviteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestInviteRequest{}
...
func (o RequestInviteRequest) ToMap() (map[string]interface{}, error) {
