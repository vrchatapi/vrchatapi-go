...
// checks if the PastDisplayName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PastDisplayName{}
...
func (o PastDisplayName) ToMap() (map[string]interface{}, error) {
