...
// checks if the UpdateGroupGalleryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGroupGalleryRequest{}
...
func (o UpdateGroupGalleryRequest) ToMap() (map[string]interface{}, error) {
