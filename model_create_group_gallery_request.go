...
// checks if the CreateGroupGalleryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupGalleryRequest{}
...
func (o CreateGroupGalleryRequest) ToMap() (map[string]interface{}, error) {
