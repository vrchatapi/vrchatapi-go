...
// checks if the GroupAuditLogEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupAuditLogEntry{}
...
func (o GroupAuditLogEntry) ToMap() (map[string]interface{}, error) {
