...
// checks if the InfoPushDataClickable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfoPushDataClickable{}
...
func (o InfoPushDataClickable) ToMap() (map[string]interface{}, error) {
