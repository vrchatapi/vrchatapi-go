...
// checks if the InstanceShortNameResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceShortNameResponse{}
...
func (o InstanceShortNameResponse) ToMap() (map[string]interface{}, error) {
