...
// checks if the TransactionSteamWalletInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSteamWalletInfo{}
...
func (o TransactionSteamWalletInfo) ToMap() (map[string]interface{}, error) {
