...
// checks if the WorldPublishStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorldPublishStatus{}
...
func (o WorldPublishStatus) ToMap() (map[string]interface{}, error) {
