...
// checks if the PaginatedGroupAuditLogEntryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGroupAuditLogEntryList{}
...
func (o PaginatedGroupAuditLogEntryList) ToMap() (map[string]interface{}, error) {
