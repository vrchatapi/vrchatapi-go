...
// checks if the FileUploadURL type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileUploadURL{}
...
func (o FileUploadURL) ToMap() (map[string]interface{}, error) {
