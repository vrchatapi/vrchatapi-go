...
const (
	...
	INVITE_RESPONSE NotificationType = "inviteResponse"
	REQUEST_INVITE NotificationType = "requestInvite"
	REQUEST_INVITE_RESPONSE NotificationType = "requestInviteResponse"
	VOTETOKICK NotificationType = "votetokick"
)
