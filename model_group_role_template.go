...
const (
	DEFAULT GroupRoleTemplate = "default"
	MANAGED_FREE GroupRoleTemplate = "managedFree"
	MANAGED_INVITE GroupRoleTemplate = "managedInvite"
	MANAGED_REQUEST GroupRoleTemplate = "managedRequest"
)
