...
// checks if the UpdateGroupRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGroupRoleRequest{}
...
func (o UpdateGroupRoleRequest) ToMap() (map[string]interface{}, error) {
