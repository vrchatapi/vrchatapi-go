...
const (
	MESSAGE InviteMessageType = "message"
	RESPONSE InviteMessageType = "response"
	REQUEST InviteMessageType = "request"
	REQUEST_RESPONSE InviteMessageType = "requestResponse"
)
