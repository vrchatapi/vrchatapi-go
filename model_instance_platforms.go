...
// checks if the InstancePlatforms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstancePlatforms{}
...
func (o InstancePlatforms) ToMap() (map[string]interface{}, error) {
