...
// checks if the BanGroupMemberRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BanGroupMemberRequest{}
...
func (o BanGroupMemberRequest) ToMap() (map[string]interface{}, error) {
