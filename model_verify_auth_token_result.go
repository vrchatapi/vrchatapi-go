...
// checks if the VerifyAuthTokenResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyAuthTokenResult{}
...
func (o VerifyAuthTokenResult) ToMap() (map[string]interface{}, error) {
