...
// checks if the AvatarUnityPackageUrlObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvatarUnityPackageUrlObject{}
...
func (o AvatarUnityPackageUrlObject) ToMap() (map[string]interface{}, error) {
