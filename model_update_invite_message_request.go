...
// checks if the UpdateInviteMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInviteMessageRequest{}
...
func (o UpdateInviteMessageRequest) ToMap() (map[string]interface{}, error) {
