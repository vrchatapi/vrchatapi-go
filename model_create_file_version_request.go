...
// checks if the CreateFileVersionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFileVersionRequest{}
...
func (o CreateFileVersionRequest) ToMap() (map[string]interface{}, error) {
