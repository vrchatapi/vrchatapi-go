...
// checks if the FriendStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FriendStatus{}
...
func (o FriendStatus) ToMap() (map[string]interface{}, error) {
