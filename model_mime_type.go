...
const (
	...
	IMAGE_JPG MIMEType = "image/jpg"
	IMAGE_PNG MIMEType = "image/png"
	IMAGE_WEBP MIMEType = "image/webp"
	IMAGE_GIF MIMEType = "image/gif"
	IMAGE_BMP MIMEType = "image/bmp"
	IMAGE_SVGXML MIMEType = "image/svg＋xml"
	IMAGE_TIFF MIMEType = "image/tiff"
	APPLICATION_X_AVATAR MIMEType = "application/x-avatar"
	APPLICATION_X_WORLD MIMEType = "application/x-world"
	APPLICATION_GZIP MIMEType = "application/gzip"
	APPLICATION_X_RSYNC_SIGNATURE MIMEType = "application/x-rsync-signature"
	APPLICATION_X_RSYNC_DELTA MIMEType = "application/x-rsync-delta"
	APPLICATION_OCTET_STREAM MIMEType = "application/octet-stream"
)
