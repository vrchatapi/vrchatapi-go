...
// checks if the InfoPushDataArticle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfoPushDataArticle{}
...
func (o InfoPushDataArticle) ToMap() (map[string]interface{}, error) {
